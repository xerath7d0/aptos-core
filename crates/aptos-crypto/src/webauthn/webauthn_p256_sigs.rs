...
use webauthn_rs_core::assertion::{
    generate_verification_data, p256_der_to_fixed_size_signature, parse_bcs_paarr_bytes,
};
...
/// 3. `client_data_json`
///
/// See [`parse_bcs_paarr_bytes`](webauthn_rs_core::assertion::parse_bcs_paarr_bytes)
...
impl WebAuthnSignature for WebAuthnP256Signature {
    ...
    fn verify_arbitrary_challenge(
        ...
        let paarr = parse_bcs_paarr_bytes(self.0.as_slice())?;
