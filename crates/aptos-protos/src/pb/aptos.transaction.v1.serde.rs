...
impl serde::Serialize for MultiKeySignature {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.signatures_bitmap.is_empty() {
            len += 1;
        }
        ...
        if !self.signatures_bitmap.is_empty() {
            struct_ser.serialize_field("signaturesBitmap", pbjson::private::base64::encode(&self.signatures_bitmap).as_str())?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "signatures" => Ok(GeneratedField::Signatures),
                            "signaturesBitmap" | "signatures_bitmap" => Ok(GeneratedField::SignaturesBitmap),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut signatures__ = None;
                let mut signatures_bitmap__ = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::PublicKeys => {
                            if public_keys__.is_some() {
                        ...
                        GeneratedField::SignaturesBitmap => {
                            if signatures_bitmap__.is_some() {
                                return Err(serde::de::Error::duplicate_field("signaturesBitmap"));
                            }
                            signatures_bitmap__ =
                                Some(map.next_value::<::pbjson::private::BytesDeserialize<_>>()?.0)
                            ;
                ...
                Ok(MultiKeySignature {
                    ...
                    signatures: signatures__.unwrap_or_default(),
                    signatures_bitmap: signatures_bitmap__.unwrap_or_default(),
                })
            }
        }
