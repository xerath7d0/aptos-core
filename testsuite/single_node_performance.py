...
TESTS = [
    ...
    RunGroupConfig(expected_tps=4050, key=RunGroupKey("modify-global-resource-agg-v2"), included_in=Flow.LAND_BLOCKING | Flow.REPRESENTATIVE),
    RunGroupConfig(expected_tps=12500, key=RunGroupKey("modify-global-resource-agg-v2", module_working_set_size=10), included_in=Flow.LAND_BLOCKING),
    RunGroupConfig(expected_tps=4050, key=RunGroupKey("modify-global-flag-agg-v2"), included_in=Flow.LAND_BLOCKING | Flow.REPRESENTATIVE),
    RunGroupConfig(expected_tps=12500, key=RunGroupKey("modify-global-flag-agg-v2", module_working_set_size=10), included_in=Flow.LAND_BLOCKING),
