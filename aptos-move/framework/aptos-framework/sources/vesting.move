...
module aptos_framework::vesting {
    ...
    public entry fun test_set_beneficiary_for_operator(
        ...
        // 10% commission will be paid to the operator.
        update_operator(admin, contract_address, operator_address, 10);
        assert!(staking_contract::beneficiary_for_operator(operator_address) == operator_address, 0);
        set_beneficiary_for_operator(operator, beneficiary_address);
        assert!(staking_contract::beneficiary_for_operator(operator_address) == beneficiary_address, 0);
