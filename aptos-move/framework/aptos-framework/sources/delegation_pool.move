...
module aptos_framework::delegation_pool {
    ...
    #[event]
    struct DistributeCommissionEventV2 has drop, store {
        pool_address: address,
        operator: address,
        beneficiary: address,
        commission_active: u64,
    ...
    public fun get_stake(pool_address: address, delegator_address: address): (u64, u64, u64) acquires DelegationPool, Beneficiary {
        assert_delegation_pool_exists(pool_address);
        let pool = borrow_global<DelegationPool>(pool_address);
        let (
            lockup_cycle_ended,
    ...
    /// latest state.
    public fun calculate_and_update_voter_total_voting_power(pool_address: address, voter: address): u64 acquires DelegationPool, GovernanceRecords, Beneficiary {
    ...
    /// latest state.
    public fun calculate_and_update_remaining_voting_power(pool_address: address, voter_address: address, proposal_id: u64): u64 acquires DelegationPool, GovernanceRecords, Beneficiary {
        assert_partial_governance_voting_enabled(pool_address);
    ...
    ) acquires DelegationPool, GovernanceRecords, Beneficiary {
    ...
    public entry fun vote(voter: &signer, pool_address: address, proposal_id: u64, voting_power: u64, should_pass: bool) acquires DelegationPool, GovernanceRecords, Beneficiary {
        assert_partial_governance_voting_enabled(pool_address);
        // synchronize delegation and stake pools before any user operation.
        synchronize_delegation_pool(pool_address);
    ...
    ) acquires DelegationPoolOwnership, DelegationPool, GovernanceRecords, Beneficiary {
    ...
    public entry fun add_stake(delegator: &signer, pool_address: address, amount: u64) acquires DelegationPool, GovernanceRecords, Beneficiary {
    ...
    public entry fun unlock(delegator: &signer, pool_address: address, amount: u64) acquires DelegationPool, GovernanceRecords, Beneficiary {
    ...
    public entry fun reactivate_stake(delegator: &signer, pool_address: address, amount: u64) acquires DelegationPool, GovernanceRecords, Beneficiary {
    ...
    public entry fun withdraw(delegator: &signer, pool_address: address, amount: u64) acquires DelegationPool, GovernanceRecords, Beneficiary {
    ...
    public entry fun synchronize_delegation_pool(pool_address: address) acquires DelegationPool, GovernanceRecords, Beneficiary {
        assert_delegation_pool_exists(pool_address);
        let pool = borrow_global_mut<DelegationPool>(pool_address);
        let (
            lockup_cycle_ended,
        ...
        emit(DistributeCommissionEventV2 {
            pool_address,
            operator: stake::get_operator(pool_address),
    ...
    ) acquires DelegationPool, Beneficiary {
    ...
    ): u64 acquires DelegationPoolOwnership, DelegationPool, GovernanceRecords, Beneficiary {
        initialize_for_test_no_reward(aptos_framework);
        aptos_governance::initialize_for_test(
            aptos_framework,
            (10 * ONE_APT as u128),
